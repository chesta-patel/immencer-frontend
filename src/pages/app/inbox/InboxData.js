    ...
    message: {
      ...
      reply: [
        ...
        },
        {
          ...
          replyMessage: [
            'Sorry',
            'We currently do not have any codes',
            'Thank you',
          ],
        },
      ],
...
export const navData = [
  {
    ...
    badge: {
      text: function () {
        let defaultData = inboxList.filter(
          (item) => item.message.meta.inbox === true
        )
  ...
  },
  {
    ...
    badge: {
      text: function () {
        let defaultData = inboxList.filter(
          (item) => item.message.meta.draft === true
        )
        return defaultData.length
      },
      theme: 'light',
