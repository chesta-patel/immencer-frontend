export const columnData = {
  task: {
    'task-1': {
      ...
      meta: {
        users: [
          { value: 'Sara Dervashi', label: 'Sara Dervashi', theme: 'light' },
        ],
        tags: [
    ...
    'task-2': {
      ...
      meta: {
        users: [
          { value: 'Cooper Jones', label: 'Cooper Jones', theme: 'blue' },
        ],
        tags: [
          { value: 'Dashlite', label: 'Dashlite', theme: 'info' },
    ...
    'task-3': {
      ...
      meta: {
        users: [
          { value: 'Ashraf Raneem', label: 'Ashraf Raneem', theme: 'primary' },
        ],
        tags: [
          { value: 'Dashlite', label: 'Dashlite', theme: 'info' },
    ...
    'task-4': {
      ...
      meta: {
        users: [
          {
            value: 'Vernon Hollander',
            label: 'Vernon Hollander',
            theme: 'danger',
          },
        ],
        tags: [
    ...
    'task-5': {
      ...
      meta: {
        users: [
          { value: 'Patrick Newman', label: 'Patrick Newman', theme: 'pink' },
        ],
        tags: [
    ...
    'task-8': {
      ...
      meta: {
        users: [
          ...
          {
            value: 'Sergei Surnama',
            label: 'Sergei Surnama',
            theme: 'success',
          },
        ],
        tags: [
