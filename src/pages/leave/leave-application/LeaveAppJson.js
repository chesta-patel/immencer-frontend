...
export const leaveAppForm = [
  ...
  },
  {
    id: 2,
    label_class: 'form-label',
    label_name: `${commonString.leave_type_id}`,
    input_class: 'form-control',
    type: 'number',
    name: `${commonString.leave_type_id}`,
    required: `${commonString.Please_enter} ${commonString.leave_type_id}`,
    placeholder: `${commonString.enter} ${commonString.leave_type_id}`,
  },
  {
    id: 3,
    label_class: 'form-label',
  ...
  },
  {
    ...
    option: [
      ...
      { value: `${commonString.approved}`, label: `${commonString.approved}` },
      { value: `${commonString.reject}`, label: `${commonString.reject}` },
    ],
  },
  {
    id: 8,
    ...
    required: `${commonString.Please_enter} ${commonString.approved} ${commonString.date}`,
  },
  {
    id: 9,
    label_class: 'form-label',
