          ...
          <BlockHeadContent>
            ...
            <BlockDes>
              <p className="lead">
                ...
                with the handful of available and flexible alert messages. To
                use it, import it such as{' '}
                <code>import {`{Alert}`} from "reactstrap"</code>. Visit the{' '}
                <a
                  href={
        ...
        <Block size="lg">
          <BlockHead>
            <BlockHeadContent>
              ...
              <p>
                Alerts are available for any length of text. Use{' '}
                <code> {`Alert`}</code> component with <code>color</code> props
            ...
            <div className="gy-4">
              <div>
                <Alert className="alert-icon" color="primary">
                  ...
                  <strong>Order has been placed</strong>. You will be redirected
              ...
              <div>
                <Alert className="alert-icon" color="success">
                  ...
                  <strong>Thanks for your deposit</strong>. Your account balance
              ...
              <div>
                <Alert className="alert-icon" color="danger">
                  ...
                  <strong>Update failed</strong>! There is some technical
                  issues.
                </Alert>
              </div>
              <div>
                <Alert className="alert-icon" color="warning">
                  <Icon name="alert-circle" />
                  Your credit card <strong>already expired</strong>. Please
                  enter a valid &amp; up-to-date{' '}
              ...
              <div>
                <Alert className="alert-icon" color="info">
                  <Icon name="alert-circle" />
                  <strong>Order has been placed</strong>. Your will be
          ...
          <PreviewTable>
            <thead className="thead-light">
              <tr>
                <th className="overline-title w-300px">
                  Props & Classname Reference
                </th>
            ...
            <tbody>
              <tr>
                ...
                <td>
                  ...
                  <code>
                    primary, secondary, success, info, warning, danger, gray,
                    light
                  </code>
                </td>
              </tr>
        ...
        <Block size="lg">
          <BlockHead>
            <BlockHeadContent>
              ...
              <p>
                For following style, You can use the <code>.alert-pro</code>{' '}
                class with <code>Alert</code> component.
              </p>
            </BlockHeadContent>
          </BlockHead>
              ...
              <div className="example-alert">
                <Alert className="alert-pro" color="primary">
                  <div className="alert-text">
                    ...
                    <p>
                      Your order has been successfully placed for deposit. You
                      will be redirected to payment portal.{' '}
                    </p>
                  </div>
                </Alert>
              </div>
              ...
              <div className="example-alert">
                <Alert className="alert-pro" color="success">
                  <div className="alert-text">
                    ...
                    <p>
                      Thanks for your deposit. Now you can see your transaction
                      history. Your account has been updated accordingly.{' '}
                    </p>
                  </div>
                </Alert>
              </div>
              ...
              <div className="example-alert">
                <Alert className="alert-pro" color="warning">
                  <div className="alert-text">
                    ...
                    <p>
                      Sorry! your credit card already expired. Please enter a
                      valid &amp; up-to-date credit card to deposit your money.
                    </p>
                  </div>
                </Alert>
              </div>
              <div className="example-alert">
                <Alert className="alert-pro" color="danger">
                  <div className="alert-text">
                    ...
                    <p>
                      Your order has been cancelled due to received your
                      payment.
                    </p>
                  </div>
                </Alert>
