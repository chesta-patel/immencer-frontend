      ...
      <Content page="component">
        <BlockHead size="lg" wide="sm">
          <BlockHeadContent>
            ...
            <BlockDes>
              <p className="lead">
                Examples for adding custom reactStrap tooltips with CSS and
                JavaScript using CSS3 for animations. To use it, import it such
                as <code>import {`{Tooltip}`} from "reactstrap"</code>. Visit
                the{' '}
                <a
                  href={
        ...
        <Block size="lg">
          <BlockHead>
            <BlockHeadContent>
              ...
              <p>
                Elements with the <code>disabled</code> props aren’t
