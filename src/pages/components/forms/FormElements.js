          ...
          <BlockHeadContent>
            ...
            <BlockDes>
              <p className="lead">
                ...
                forms. Here’s a quick example to demonstrate form styles, so use
          ...
          <BlockHead>
            <BlockHeadContent>
              ...
              <p>
                ...
                <code className="code-tag">&lt;textarea&gt;</code>s—are styled
                with the <code>.form-control</code> className. Included are
                  ...
                  <div className="form-control-wrap">
                    <div className="form-control-select-multiple">
                      ...
                      >
                        ...
                        <option value="option_select1">
                          Option select name
                        </option>
                        <option value="option_select2">
                          Option select name
                        </option>
                        <option value="option_select2">
                          Option select name
            ...
            <Row className="gy-4 align-center">
              ...
              <Col lg="12">
                <p className="text-soft">
                  Use <code>.form-control-lg</code> or{' '}
                  <code>.form-control-sm</code> with <code>.form-control</code>{' '}
            ...
            <Row className="gy-4">
              ...
              <Col size="12">
                <p className="text-soft">
                  ...
                  <code>.form-control</code> for outlined form element and
                  replace <code>.form-label</code> with{' '}
                  <code>.form-label-outlined</code>, also place label after
        ...
        <Block size="lg">
          <BlockHead>
            <BlockHeadContent>
              ...
              <p>
                To use the Dashlite customized version of react-select component
                import it such as,{' '}
                <code>
                  import {`{RSelect}`} from "/components/Component.js"
                </code>
                . Visit the official documentaion{' '}
                <a
