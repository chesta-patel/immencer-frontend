      ...
      <Content page="component">
        <BlockHead size="lg" wide="sm">
          <BlockHeadContent>
            ...
            <BlockDes>
              <p className="lead">
                Examples and usage guidelines for custom styled Checkbox and
                Radio.
              </p>
            </BlockDes>
          </BlockHeadContent>
        ...
        <Block size="lg">
          <BlockHead>
            <BlockHeadContent>
              ...
              <BlockDes>
                <p>
                  For Grouped checkbox, use <code>custom-control-pro</code>{' '}
                  class with <code>custom-control</code> also if you want to
                  hide control then use <code>no-control</code> class with it.{' '}
                  <br /> For group use{' '}
                  <code>
                    ul.custom-control-group &gt; li &gt; .custom-control
                  </code>{' '}
                  if you want vertical them use{' '}
        ...
        <Block size="lg">
          <BlockHead>
            <BlockHeadContent>
              ...
              <BlockDes>
                <p>
                  For Grouped radio, use <code>custom-control-pro</code> class
                  with <code>custom-control</code> also if you want to hide
                  control then use <code>no-control</code> class with it. <br />{' '}
                  For group use{' '}
                  <code>
                    ul.custom-control-group &gt; li &gt; .custom-control
                  </code>{' '}
        ...
        <Block size="lg">
          <BlockHead>
            <BlockHeadContent>
              ...
              <BlockDes>
                <p>
                  You can create checkbox or radio with any styled element, just
                  like displayed below. just add{' '}
                  <code>.custom-control-pro</code> class with{' '}
                  <code>.custom-control</code> then put that styled element in{' '}
                  <code className="code-tag">&lt;label&gt;</code> tag. An
                  example with user card shown for display purpose. <br />{' '}
