...
const FlexPage = ({ ...props }) => {
    ...
    <React.Fragment>
      ...
      <Content page="component">
        ...
        <Block size="lg">
          ...
          <PreviewCard>
            <div className="d-flex p-2 bg-lighter">
          ...
          <BlockHead>
            <BlockHeadContent>
              ...
              <p>
                ...
                <code className="highlighter-rouge">row</code>. If you want to
                change direction then use{' '}
                <code className="highlighter-rouge">flex-row</code> for
                horizontal direction,{' '}
                <code className="highlighter-rouge">flex-row-reverse</code> for
                opposite horizontal direction. Default Vertical direction is{' '}
                <code className="highlighter-rouge">column</code>,for it use{' '}
                <code className="highlighter-rouge">flex-column</code> or{' '}
                <code className="highlighter-rouge">flex-column-reverse</code>{' '}
                for opposit vertical direction
              </p>
            </BlockHeadContent>
          </BlockHead>
          <PreviewCard>
          ...
          <BlockHead>
            <BlockHeadContent>
              ...
              <p>
                ...
                utilities for change the alignment of flex items. There are many
                classNames. just add{' '}
        ...
        <Block size="lg">
          <BlockHead>
            <BlockHeadContent>
              ...
              <p>
                On flexbox container use{' '}
                <code className="highlighter-rouge">align-items</code> utilities
                for change the alignment of flex items on the cross axis. There
                are many classNames. just add{' '}
                <code className="highlighter-rouge">
        ...
        <Block size="lg">
          <BlockHead>
            <BlockHeadContent>
              ...
              <p>
                ...
                <code className="highlighter-rouge">align-self</code> utilities
                for change the alignment. There are many classNames. just add{' '}
                <code className="highlighter-rouge">
                  (start, end, center, baseline, stretch)
                </code>{' '}
          ...
          <PreviewCard>
            <div className="d-flex mb-3" style={{ height: 100 }}>
              <div className="p-2 bg-light">Flex item</div>
              <div className="align-self-start p-2 bg-light">
                Aligned flex item
              </div>
              <div className="p-2 bg-light">Flex item</div>
            </div>
            <div className="d-flex mb-3" style={{ height: 100 }}>
              <div className="p-2 bg-light">Flex item</div>
              <div className="align-self-end p-2 bg-light">
                Aligned flex item
              </div>
              <div className="p-2 bg-light">Flex item</div>
            </div>
            <div className="d-flex mb-3" style={{ height: 100 }}>
              <div className="p-2 bg-light">Flex item</div>
              <div className="align-self-center p-2 bg-light">
                Aligned flex item
              </div>
              <div className="p-2 bg-light">Flex item</div>
            </div>
            <div className="d-flex mb-3" style={{ height: 100 }}>
              <div className="p-2 bg-light">Flex item</div>
              <div className="align-self-baseline p-2 bg-light">
                Aligned flex item
              </div>
              <div className="p-2 bg-light">Flex item</div>
            </div>
            <div className="d-flex" style={{ height: 100 }}>
              <div className="p-2 bg-light">Flex item</div>
              <div className="align-self-stretch p-2 bg-light">
                Aligned flex item
              </div>
              <div className="p-2 bg-light">Flex item</div>
            </div>
        ...
        <Block size="lg">
          <BlockHead>
            <BlockHeadContent>
              ...
              <p>
                Use <code className="highlighter-rouge">flex-fill</code> class
                on flex-items
              </p>
            </BlockHeadContent>
          </BlockHead>
        ...
        <Block size="lg">
          <BlockHead>
            <BlockHeadContent>
              ...
              <p>
                Use <code className="highlighter-rouge">.flex-grow-*</code>{' '}
                utilities to toggle a flex item’s ability to grow to fill
                available space. In the example below, the{' '}
                <code className="highlighter-rouge">.flex-grow-1</code> elements
                uses all available space it can, while allowing the remaining
          ...
          <BlockHead>
            <BlockHeadContent>
              ...
              <p>
                ...
                <code className="highlighter-rouge">mr-auto</code> class on flex
                items.
              </p>
            </BlockHeadContent>
          </BlockHead>
          ...
          <BlockHead>
            <BlockHeadContent>
              ...
              <p>
                ...
                <code className="highlighter-rouge">mb-auto</code> className on
                flex items.
              </p>
            </BlockHeadContent>
          </BlockHead>
  ...
  <div className="p-2">Flex item</div>
        ...
        <Block size="lg">
          <BlockHead>
            <BlockHeadContent>
              ...
              <p>
                ...
                <code className="highlighter-rouge">.flex-nowrap</code>,
                wrapping with{' '}
                <code className="highlighter-rouge">.flex-wrap</code>, or
                reverse wrapping with{' '}
          ...
          <PreviewCard>
            <div
              className="d-flex flex-nowrap bg-lighter"
              style={{ width: 8 + 'rem' }}
            >
              <div className="p-2 bg-light">Flex item</div>
              <div className="p-2 bg-light">Flex item</div>
          ...
          <BlockHead>
            <BlockHeadContent>
              ...
              <p>
                ...
                <code className="highlighter-rouge">order</code> utilities. We
                only provide options for making an item first or last, as well
                as a reset to use the DOM order.
              </p>
            </BlockHeadContent>
          </BlockHead>
          <PreviewCard>
          ...
          <BlockHead>
            <BlockHeadContent>
              ...
              <p>
                ...
                demonstrate these utilities, we’ve enforced{' '}
                <code>flex-wrap: wrap</code> and increased the number of flex
                items.
              </p>
            </BlockHeadContent>
          </BlockHead>
