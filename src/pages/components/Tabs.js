      ...
      <Content page="component">
        <BlockHead size="lg" wide="sm">
          <BlockHeadContent>
            ...
            <BlockDes>
              <p className="lead">
                Use the Reactstrap tab component, tabs and pills to create
                tabbable panes of local content, even via dropdown menus. To use
                it, import it such as{' '}
                <code>
        ...
        <Block size="lg">
          <BlockHead>
            <BlockHeadContent>
              ...
              <p>
                You can simply activate a tab or pill navigation, add{' '}
                <code>tabs</code> or <code>pills</code> props to{' '}
                <code>Nav</code> component. Here is some basic tab component
                that you can use. Visit the{' '}
                <a
                  href={
            ...
            <TabContent activeTab={activeTab}>
              <TabPane tabId="1">
                <p>
                  ...
                  est eu aliqua occaecat quis et velit excepteur laborum mollit
                  dolore eiusmod. Ipsum dolor in occaecat commodo et voluptate
                  minim reprehenderit mollit pariatur. Deserunt non laborum enim
                  et cillum eu deserunt excepteur ea incid.
                </p>
              </TabPane>
              <TabPane tabId="2">
                <p>
                  ...
                  consectetur adipisicing officia excepteur non sit. Ut et elit
                  aliquip labore Lorem enim eu. Ullamco mollit occaecat dolore
                  ipsum id officia mollit qui esse anim eiusmod do sint minim
                  consectetur qui.
                </p>
              </TabPane>
              <TabPane tabId="3">
              ...
              <TabPane tabId="4">
                <p>
                  ...
                  aliqua do. Aliqua amet qui mollit consectetur nulla mollit
                  velit aliqua veniam nisi id do Lorem deserunt amet. Culpa
                  ullamco sit adipisicing labore officia magna elit nisi in aute
        ...
        <Block size="lg">
          <BlockHead>
            <BlockHeadContent>
              ...
              <p>
                You can simply activate add <code>.nav-tabs-s2</code> className
                in <code>Nav</code> component to make an alternet styled tab.
              </p>
            </BlockHeadContent>
          </BlockHead>
          <PreviewCard>
        ...
        <Block size="lg">
          <BlockHead>
            <BlockHeadContent>
              ...
              <p>
                You can simply activate add <code>.link-list-menu</code>{' '}
                className in <code>Nav</code> component to make a vertical
                styled tab.
              </p>
            </BlockHeadContent>
          </BlockHead>
